var LandingPage = (function() {
  ...
  function render(container) {
    container.innerHTML = [
      ...
      '      <div class="lp-faq-item"><div class="lp-faq-q">Comment les réponses sont-elles générées ?<span class="lp-faq-plus">+</span></div><div class="lp-faq-a">Notre IA s\'appuie sur les dernières avancées en intelligence artificielle. Elle analyse le contexte de chaque avis — note, ton, sujet — pour générer une réponse naturelle et adaptée à votre secteur.</div></div>',
